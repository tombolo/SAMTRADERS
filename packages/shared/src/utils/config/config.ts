...
export const domain_app_ids = {
    'derivstart.com': 98130,
    'deriv.app': 98130,
    'app.deriv.com': 98130,
    'staging-app.deriv.com': 98130,
    'app.deriv.me': 98130,
    'staging-app.deriv.me': 98130,
    'app.deriv.be': 98130,
    'staging-app.deriv.be': 98130,
    'binary.com': 98130,
    'test-app.deriv.com': 98130,
    'royal-app-seven.vercel.app': 98130,
    'star-eight-ruby.vercel.app': 98130,
    'beleiver.vercel.app': 98130,
    'goon-puce.vercel.app': 98130,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 98130 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 98130;
