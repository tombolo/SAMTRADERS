...
export const domain_app_ids = {
    'derivstart.com': 85136,
    'deriv.app': 85136,
    'app.deriv.com': 85136,
    'staging-app.deriv.com': 85136,
    'app.deriv.me': 85136,
    'staging-app.deriv.me': 85136,
    'app.deriv.be': 85136,
    'staging-app.deriv.be': 85136,
    'binary.com': 85136,
    'test-app.deriv.com': 85136,
    'royal-app-seven.vercel.app': 85136,
    'star-eight-ruby.vercel.app': 85136,
    'beleiver.vercel.app': 85136,
    'goon-puce.vercel.app': 85136,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 85136 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 85136;
